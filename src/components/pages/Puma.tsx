...
import pumaModel1 from '../../assets/puma 1.jpg'
...
export const pumaModels: PumaModelsType[] = [
    {
        id:0,
        model: 'PUMA MODEL STREET_X',
